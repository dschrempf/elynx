{- |
Module      :  EvoMod.Simulate.MarkovChainAlongTreeSpec
...
testTree :: PhyloIntTree
testTree = Node (PhyloLabel 0 0.0) [ Node (PhyloLabel 1 1.0) [], Node (PhyloLabel 2 1.0) [] ]

testStateTree :: Tree State
testStateTree = Node 0 [Node 0 [], Node 2 []]

nullTree :: PhyloIntTree
nullTree = Node (PhyloLabel 0 0.0) []

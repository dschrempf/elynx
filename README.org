...
The Elynx Suite consists of three library packages:
...
and two executables providing a range of sub commands:
...
[1mslynx[0m     Analyze, modify, and simulate evolutionary sequences.
[1mtlynx[0m     Analyze, modify, and simulate phylogenetic trees.
#+end_example

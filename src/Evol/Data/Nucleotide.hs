...
import           Evol.Data.Alphabet as A
...
nucleotides = Alphabet . S.fromList . map toWord . enumFrom $ A

instance Code Nucleotide where
...
nucleotidesIUPAC = Alphabet . S.fromList . map nucleotideIUPACToWord . enumFrom $ A_IUPAC

instance Code NucleotideIUPAC where
